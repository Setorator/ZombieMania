...
public final class EnemyFactory
{
	...
	switch (type) {
		...
		creep.setHeight(2);
		creep.updateEdges();
		creep.setLeftImage(ResourceLoader.loadImageResource("Resources/Pictures/soldierleft.gif").getImage());
		creep.setRightImage(ResourceLoader.loadImageResource("Resources/Pictures/soldierright.gif").getImage());
		...
		hound.setHeight(1);
		hound.updateEdges();
		hound.setLeftImage(ResourceLoader.loadImageResource("Resources/Pictures/dog.png").getImage());
		hound.setRightImage(ResourceLoader.loadImageResource("Resources/Pictures/dog.png").getImage());
